...
Encryption enables communication among adversaries. With EnKryptos, your encrypted files and messages will be virtually unbreakable as long as your key remains undiscovered. This application uses the AES256-CBC cipher (approved by the U.S. National Security Agency (NSA) for protecting top-secret information) with a random key of 500 character length.
